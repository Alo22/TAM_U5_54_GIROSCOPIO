package com.example.tam_54_giroscopio_gonzalezalondra;
...
public  class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_X=(TextView)findViewById(R.id.textView);
        txt_Y=(TextView)findViewById(R.id.textView4);
        txt_Z=(TextView)findViewById(R.id.textView6);
